...
import com.nikkianotaciones.ejemplo.Init;
import com.nikkianotaciones.ejemplo.JsonAtributo;
import com.nikkianotaciones.ejemplo.procesador.exception.JsonSerializadorException;
...
public class JsonSerializador {
    ...
    public static   String  convertirJson(Object object) {
        ...
        //va filtrar por donde tenga la anotacion jsonatributw
        String json = Arrays.stream(atributos).filter(f -> f.isAnnotationPresent(JsonAtributo.class))
                .map(f -> {
                    //f se refiere al field
                    f.setAccessible(true); //darle permiso del campo
