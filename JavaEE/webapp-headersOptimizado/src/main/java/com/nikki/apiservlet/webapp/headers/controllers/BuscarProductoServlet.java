...
public class BuscarProductoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(service.buscarProducto(nombre).isPresent()){
            ...
            try(PrintWriter out = resp.getWriter()) {
                ...
                out.println("           <ul>");
                out.println("           <li> ID:" + service.buscarProducto(nombre).get().getId() + " </li>");
                out.println("           <li> NOMBRE:" + service.buscarProducto(nombre).get().getNombre() + " </li>");
                out.println("           <li> TIPO:" + service.buscarProducto(nombre).get().getTipo() + " </li>");
                out.println("           <li> PRECIO:" + service.buscarProducto(nombre).get().getPrecio() + " </li>");
                out.println("           </ul>");
                out.println("    </body>");
                out.println("</html>");
            }
