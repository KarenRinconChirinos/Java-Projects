...
<body>
    ...
    %>
        <ul class="alert alert-danger nx-5 px-5">
                ...
                <input type="text" name="username" id="username" class="form-control" value="${param.username}">
                    ...
                    <%
                        if(errores != null && errores.containsKey("username")){
                            out.println("<div class='alert alert-danger col-sn-4' style='color: red;'>" + errores.get("username") + "</div>");
                        }
                    %>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <%
                if(errores != null && errores.containsKey("email")){
                    out.println("<small class='alert alert-danger col-sn-4' style='color: red;'>" + errores.get("email") + "</small>");
                }
            %>
        </div>
        <div class="row mb-3">
            ...
            <%
                if(errores != null && errores.containsKey("pais")){
                    out.println("<small class='alert alert-danger col-sn-4' style='color: red;'>" + errores.get("pais") + "</small>");
                }
            %>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-4">
                <select name="lenguajes" id="lenguajes"  class="form-select" multiple>
                    ...
                    <option value="jakartaee" ${paramValues.lenguajes.stream().anyMatch(v->v.equals("jakartaee")).get()?"selected":""} > JakartaEE9 </option>
            ...
            <%
                if(errores != null && errores.containsKey("lenguajes")){
                    out.println("<small class='alert alert-danger col-sn-4' style='color: red;'>" + errores.get("lenguajes") + "</small>");
                }
            %>
        </div>
        ...
        <div class="row mb-3">
            ...
            <%
                if(errores != null && errores.containsKey("roles")){
                    out.println("<small class='alert alert-danger col-sn-4' style='color: red;'>" + errores.get("roles") + "</small>");
                }
            %>
        </div>
        <div class="row mb-3">
            ...
            <%
                if(errores != null && errores.containsKey("idioma")){
                    out.println("<small class='alert alert-danger col-sn-4'  style='color: red;'>" + errores.get("idioma") + "</small>");
                }
            %>
        </div>
        <div class="row mb-3 col-sm-2">
            <label for="habilitar" class="col-form-label col-sm-2">Habilitar</label>
            <div class="form-check"><input type="checkbox" name="habilitar" id="habilitar" checked class="form-check-input"></div>
        </div>
        <div class="row mb-3">
